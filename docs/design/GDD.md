...
- `GameManager`: persistenza, stato globale, credenziali acquisite e incidenti/focolai risolti.
...
- `GuardiaNpc`, `DroneRonda`, `ManutenzioneBot`: minacce, pattuglie e combattimento.
- `EmergencyScanner`: scanner di emergenza per credenziali, focolai, terminali/interagibili e firme di sicurezza.
