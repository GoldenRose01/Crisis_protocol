...
public class DatapadOlogrammaUI : MonoBehaviour
{
    ...
    // ESC chiude il datapad come una modale standard, senza lasciare il player bloccato.
    private bool TastoChiusuraPremuto()
    {
        bool escNuovoInput = Keyboard.current != null && Keyboard.current.escapeKey.wasPressedThisFrame;
        bool escInputVecchio = Input.GetKeyDown(KeyCode.Escape);
        return escNuovoInput || escInputVecchio;
    }
    ...
    private void CostruisciUISeNecessario()
    {
        ...
        rtTxtClose.offsetMin = Vector2.zero;
        rtTxtClose.offsetMax = Vector2.zero;
        ...
        rtHoloClose.pivot = new Vector2(1, 0.5f);
        ...
        txtBtn.text = "[X] CHIUDI HOLOPAD (ESC)";
        txtBtn.fontSize = 15;
