...
public class EmergencyHotspot : MonoBehaviour, IInteractable
{
    ...
    public void GeneraPerditaGasSeAssente()
    {
        ...
        psJet.Stop(true, ParticleSystemStopBehavior.StopEmittingAndClear);
        ...
        psCloud.Stop(true, ParticleSystemStopBehavior.StopEmittingAndClear);
        ...
        hazardCollider.radius    = Mathf.Max(0.5f, 2.2f * sc);
