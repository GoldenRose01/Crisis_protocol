...
{ // apre // riga-ok
    ...
    [MenuItem("GitHub/Salva e Chiudi Sessione")] // nota unity // riga-ok
    ...
    { // apre // riga-ok
        ...
        string commitMessage = $"Sessione terminata il {System.DateTime.Now:dd/MM/yyyy HH:mm}"; // setta // riga-ok
    ...
    { // apre // riga-ok
        ...
        { // apre // riga-ok
            ...
            WorkingDirectory = workingDirectory, // <-- Parametro fondamentale per il path di esecuzione // setta // riga-ok
